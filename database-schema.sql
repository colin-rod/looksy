...
CREATE TABLE mock_products (
  ...
  description TEXT,
  colors JSONB,
  style_tags TEXT[], -- ["minimalist", "casual"]
  affiliate_url TEXT,
  created_at TIMESTAMPTZ DEFAULT NOW()
);
...
-- Insert MVP style taxonomy data
...
-- Insert some mock products for testing
INSERT INTO mock_products (title, category, subcategory, brand, price, description, colors, style_tags, affiliate_url) VALUES
('Classic White Button Shirt', 'top', 'shirt', 'Uniqlo', 29.90, 'Crisp cotton button-down shirt', '{"primary": "#FFFFFF"}', '["minimalist", "business_casual"]', 'https://example.com/white-shirt'),
('Dark Wash Straight Jeans', 'bottom', 'jeans', 'Levi''s', 79.50, 'Classic straight-leg denim', '{"primary": "#2F4F4F"}', '["casual", "minimalist"]', 'https://example.com/jeans'),
('Black Leather Sneakers', 'shoes', 'sneakers', 'Adidas', 120.00, 'Clean leather sneakers', '{"primary": "#000000"}', '["minimalist", "casual", "streetwear"]', 'https://example.com/sneakers'),
('Navy Blazer', 'outer', 'blazer', 'J.Crew', 198.00, 'Structured navy blazer', '{"primary": "#191970"}', '["business_casual", "dressy"]', 'https://example.com/blazer'),
('Athletic Leggings', 'bottom', 'leggings', 'Lululemon', 98.00, 'High-waisted workout leggings', '{"primary": "#000000"}', '["athletic"]', 'https://example.com/leggings');